...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
            int menuItemThatWasSelcted = item.getItemId();
            if (menuItemThatWasSelcted == R.id.action_search){
                Context contrext = MainActivity.this ;
                String message = "Hi this has been finished";
                Toast.makeText(contrext, message, Toast.LENGTH_LONG).show();
            };
