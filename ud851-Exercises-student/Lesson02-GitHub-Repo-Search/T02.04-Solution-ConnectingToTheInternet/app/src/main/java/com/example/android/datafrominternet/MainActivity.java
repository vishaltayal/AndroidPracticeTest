...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        new GitHubSearchQuery().execute(githubSearchUrl);
    }
    ...
    private class GitHubSearchQuery extends AsyncTask<URL, Void, String> {
        @Override
        ...
        protected String doInBackground(URL... params) {
            ...
            String gitsearch = null;
            try {
                gitsearch = NetworkUtils.getResponseFromHttpUrl(searchUrl);
            }
